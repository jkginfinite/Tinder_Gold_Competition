...
[*Table 1*](Technical_doc.ipynb#seven7)
...
![Figure 1](Tinder_gold_before_after_breakdown.png)
...
![Figure2](Volumne_PlusVsGold.png)
...
![Figure 3](Regression_PlusVsGold.png)
...
*[Figure 4](Technical_doc.ipynb#figure4): Note that the churn line (blue) is supposed to end early, because you want to give atleast one business quarter for identifying a churn. The thicker lines are the 30day averages, the faint ones are the daily fluctuations.*

![Figure4](TinderPlusChurn.png)
...
![Figure5](Tinder_Plus_new_repeat.png)
...
![rev_customer](revenue_per_customer.png)
...
There were four anomalies in the data to be noted. One situation which is relevant to this presentation demonstrates a somewhat analogous situation to Tinder Gold's growth. [The other anomalies can be found in the technical document](Technical_doc.ipynb#anomalies).
